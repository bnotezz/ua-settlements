...
module.exports = {
	"class": L.Class.extend({
		options: {
			service_url: 'https://web.archive.org/web/20211007075204/http://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer'
		},
...
module.exports = {
	"class": L.Class.extend({
		...
		geocode : function (query, cb, context) {
			Util.jsonp('https://web.archive.org/web/20211007075204/https://dev.virtualearth.net/REST/v1/Locations', {
				query: query,
				key : this.key
			}, function(data) {
				var results = [];
		...
		reverse: function(location, scale, cb, context) {
			Util.jsonp('//web.archive.org/web/20211007075204/https://dev.virtualearth.net/REST/v1/Locations/' + location.lat + ',' + location.lng, {
				key : this.key
			}, function(data) {
				var results = [];
				for (var i = data.resourceSets[0].resources.length - 1; i >= 0; i--) {
...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'https://web.archive.org/web/20211007075204/https://maps.googleapis.com/maps/api/geocode/json',
...
module.exports = {
    "class": L.Class.extend({
        options: {
            geocodeUrl: 'https://web.archive.org/web/20211007075204/http://geocoder.api.here.com/6.2/geocode.json',
            reverseGeocodeUrl: 'https://web.archive.org/web/20211007075204/http://reverse.geocoder.api.here.com/6.2/reversegeocode.json',
...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'https://web.archive.org/web/20211007075204/https://api.tiles.mapbox.com/v4/geocode/mapbox.places-v1/',
			geocodingQueryParams: {},
			reverseQueryParams: {}
		},
...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'https://web.archive.org/web/20211007075204/https://www.mapquestapi.com/geocoding/v1'
		},
...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'https://web.archive.org/web/20211007075204/https://search.mapzen.com/v1',
			geocodingQueryParams: {},
			reverseQueryParams: {}
		},
...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'https://web.archive.org/web/20211007075204/https://nominatim.openstreetmap.org/',
			geocodingQueryParams: {},
			reverseQueryParams: {},
...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'https://web.archive.org/web/20211007075204/https://photon.komoot.de/api/',
			reverseUrl: 'https://web.archive.org/web/20211007075204/https://photon.komoot.de/reverse/',
			nameProperties: [
				'name',
				'street',
				'suburb',
...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'https://web.archive.org/web/20211007075204/https://api.what3words.com/v2/'
		},
...
/*
     FILE ARCHIVED ON 07:52:04 Oct 07, 2021 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 7.841
  LoadShardBlock: 51.199 (3)
  PetaboxLoader3.datanode: 74.276 (4)
  load_resource: 170.173
  PetaboxLoader3.resolve: 142.737
*/